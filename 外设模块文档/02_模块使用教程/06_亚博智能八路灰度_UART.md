...
| 亚博智能模块 | 点浮 MSPM0G3507 核心板/底板 | 说明 |
|---|---|---|
| `VCC` / `5V` | `5V` | 给传感器供电 |
| `GND` | `GND` | 必须共地 |
| `TX` | `PB18 / UART2_RX` | 模块发送，主板接收 |
| `RX` | `PB17 / UART2_TX` | 主板发送，模块接收 |
...
| 功能 | MCU 引脚 | 当前用途 |
|---|---|---|
| `UART2_TX` | `PB17` | 亚博 UART 发送 |
| `UART2_RX` | `PB18` | 亚博 UART 接收 |
| `PB24` | `PB24` | 指定引脚组内预留，UART 方案不接 |
| `PB25` | `PB25` | 指定引脚组内预留，UART 方案不接 |
